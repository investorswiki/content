...
keywords: Crypto
title: 零知识证明
description: 零知识证明。验证交易是否有效，无需透露有关交易的任何信息，从而提供隐私。
---
...
在加密货币和区块链技术的世界中可以找到零知识证明的一个突出的现实世界用例。使用一种称为零知识简洁非交互式知识论证 (zk-SNARK) 的证明， [Zcash等注重隐私的加密货币](/zcash)能够为其用户提供具有更高隐私级别的区块链交易。自 2017 年拜占庭更新以来，以太坊也在使用 zk-SNARK 证明。
